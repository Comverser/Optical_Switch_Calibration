...
int main(int argc, char const *argv[])
{
    ...
    while(1) // Because O_NDELAY has been used this will exit if there are no receive bytes waiting (non blocking read), so if you want to hold waiting for input simply put this in a while loop
    {
        sleep(2);

        printf("UART transmitting\n");
        //----- TX BYTES -----
